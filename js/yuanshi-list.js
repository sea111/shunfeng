					...
					if(datas.errMsg == "AES加密解密失败"){			
						...
						if(datas.success){
							...
							var mes=datas.data.list;
								str+='<ul class="ul">';
								str+="<p class='backG'></p>"
								str+='<li class="li listTitle" resultName="'+cateArr.categoryName+'" resultid="'+cateArr.categoryId+'"><i class="bgLift">'+cateArr.categoryName+'</i><span moreid='+cateArr.categoryId+' class="more">更多</span><i class="bgRight"></i></li>'							
